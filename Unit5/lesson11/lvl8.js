...
onEvent("displayButton", "click", function( ) {
	...
	setProperty("goodOutput","text",Math.round(totalGoodDays/totalDaysWithAQI*100));
	setProperty("moderateOutput","text",Math.round(totalModerateDays/totalDaysWithAQI*100));
	setProperty("unhealthyGroupsOutput","text",Math.round(totalUnhealthyGroupsDays/totalDaysWithAQI*100));
	setProperty("unhealthyOutput","text",Math.round(totalUnhealthyDays/totalDaysWithAQI*100));
	setProperty("veryUnhealthyOutput","text",Math.round(totalVeryUnhealthyDays/totalDaysWithAQI*100));
	setProperty("hazardousOutput","text",Math.round(totalHazardousDays/totalDaysWithAQI*100));
});
